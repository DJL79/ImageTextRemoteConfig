...
public class MainActivity extends AppCompatActivity
    ...
    public TextView textViewContent1, textViewContent2;
    ...
    private void displayWelcomeMessage() {
        String textViewContent2 = mFirebaseRemoteConfig.getString(TEXTVIEW_CONTENT);
        textViewContent1.setText(textViewContent2);
